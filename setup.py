...
setup(
    name='DnDiscordBot',
    version='0.01',
    packages=['venv.Lib.site-packages.aiohttp', 'venv.Lib.site-packages.chardet', 'venv.Lib.site-packages.chardet.cli',
              'venv.Lib.site-packages.discord', 'venv.Lib.site-packages.discord.ext',
              'venv.Lib.site-packages.discord.ext.ipc', 'venv.Lib.site-packages.discord.ext.commands',
              'venv.Lib.site-packages.multidict', 'venv.Lib.site-packages.websockets',
              'venv.Lib.site-packages.websockets.py35', 'venv.Lib.site-packages.async_timeout',
